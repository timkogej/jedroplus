...
import { X, SpinnerGap, FloppyDisk, Copy, Check, Lock, CheckCircle } from '@phosphor-icons/react';
import {
  SettingsSection,
  SettingRow,
  Input,
...
const CAPABILITIES = [
  ...
  'Odgovarjanje na pogosta vprasanja',
];
...
export function ChatbotSettingsModal({ isOpen, onClose }: ChatbotSettingsModalProps) {
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">AI asistent za pomoc strankam</p>
              </div>
              ...
              {isLoading ? (
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                  ...
                  <SettingsSection title="Osebnost & Ton" description="Kako naj chatbot komunicira">
                    <SettingRow label="Ime chatbota" description="Kako se bot predstavi strankam">
                      <Input
                        value={name}
                  ...
                  {/* Chatbot Link - LOCKED */}
                  <SettingsSection title="Link chatbota" description="Povezava do vasega chatbota">
                  ...
                  <SettingsSection title="Dizajn chatbota" description="Prilagodite videz chatbota">
                    ...
                    {/* Font Family */}
                    <SettingRow label="Pisava" description="Tip pisave v chatbotu">
                      <Select
