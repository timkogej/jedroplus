...
import { X, SpinnerGap, FloppyDisk, Copy, Check, Lock, Plus, Trash, Phone } from '@phosphor-icons/react';
import {
  SettingsSection,
  SettingRow,
  Input,
...
export function ReceptionistSettingsModal({ isOpen, onClose }: ReceptionistSettingsModalProps) {
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-0.5">AI telefonski asistent za vaše podjetje</p>
              </div>
