    ...
    <div className="border border-gray-200 rounded-xl overflow-hidden bg-white transition-shadow hover:shadow-sm">
      <div className="flex items-center gap-3 p-4">
        ...
        <button
          ...
          className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-gray-600 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors"
        >
          {expanded ? (
            <>
          ...
          >
            <div className="px-4 pb-4 border-t border-gray-100 pt-3 space-y-3">
              {msg.channel === 'email' && msg.subject && (
                <div>
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Zadeva</p>
              ...
              <div>
                <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Vsebina sporočila</p>
                <div
                  className="text-sm text-gray-800 bg-gray-50 rounded-lg px-3 py-2 border border-gray-200 overflow-y-auto"
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-semibold text-gray-900">Zgodovina sporočil</h2>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="w-14 h-14 rounded-full bg-gray-100 flex items-center justify-center mb-4">
            <EnvelopeSimple className="w-7 h-7 text-gray-400" />
          </div>
          <p className="text-gray-500 font-medium">Ni poslanih sporočil</p>
