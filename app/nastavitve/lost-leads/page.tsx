...
import { SpinnerGap, FloppyDisk, Plus, Minus } from '@phosphor-icons/react';
import {
  SettingsSection,
  SettingRow,
  Switch,
...
export default function LostLeadsSettingsPage() {
  ...
  const [tone, setTone] = useState('prijazen'); // Communication tone
      ...
      const webhookPayload = {
        ...
        data: buildLostLeadsSettingsData({
          ...
          nastavitveLostLeads: {
            ...
            ton_komunikacije: tone, // Tone sent to n8n
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Sledenje in ponovno pridobivanje izgubljenih strank</p>
        </div>
        ...
        <div className="flex justify-end pt-6">
          <motion.button
            ...
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-500 to-cyan-500
                       ...
                       disabled:cursor-not-allowed disabled:opacity-50 w-full justify-center"
          >
            {saving ? (
              <>
